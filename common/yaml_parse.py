...
from file_path import fp

BASE_URL = config.getUrl_BaseInfo("base_url")

ENV_MAP = {
    "https://www.wegoab.com": 1,
    "https://www.wegobiz.cn": 1,  # 测试环境2，调用测试1的配置文件
    "https://microboss.me": 3,  # 测试3使用这个网址登录返回helloworld「弃用」
    "https://www.microboss.me": 3,
    "https://3a.wegoab.com": 3,
    "https://3b.wegoab.com": 3,
    "https://3c.wegoab.com": 3,
    "https://3d.wegoab.com": 3,
    "https://www.tapbiz.cn": 4,
}
...
def get_conn_mapping(db_type):
    ...
    file_path = f"{fp.basePath}/config/test_{ENV_MAP.get(BASE_URL)}_config.yml"
...
if __name__ == "__main__":
    yp = YamlParser("F:\zhangyitao\project\SocialFinance-autotest\yaml_data\longin.yaml")
